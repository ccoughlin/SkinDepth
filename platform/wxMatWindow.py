...
'''Defines the window to revise/create materials in SkinDepth's wxPython UI'''
...
class wxMatWindow(wx.Dialog):
    ...
    def init_components(self):
        ...
        self.matname_lbl = wx.StaticText(self.main_panel,wx.ID_ANY,u"Material Name:",
                                        wx.DefaultPosition,wx.DefaultSize,0)
        self.matname_tc = wx.TextCtrl(self.main_panel,wx.ID_ANY,u"",
                                   wx.DefaultPosition,wx.DefaultSize,0)
        ...
        self.matiacs_lbl = wx.StaticText(self.main_panel,wx.ID_ANY,u"Electrical Conductivity (%IACS):",
                                        wx.DefaultPosition,wx.DefaultSize,0)
        self.matiacs_tc = wx.TextCtrl(self.main_panel,wx.ID_ANY,u"",
                                   wx.DefaultPosition,wx.DefaultSize,0)
        ...
        self.matnotes_lbl = wx.StaticText(self.main_panel,wx.ID_ANY,u"Notes:",
                                        wx.DefaultPosition,wx.DefaultSize,0)
        self.matnotes_tc = wx.TextCtrl(self.main_panel,wx.ID_ANY,u"",
                                   wx.DefaultPosition,size=wx.Size(320,75),style=wx.TE_MULTILINE|wx.TE_PROCESS_ENTER)
