...
import wxMatWindow
import wxAbout
import SkinDepthController
from material import constants

__author__ = 'Chris'
'''Defines the wxPython UI for SkinDepth'''
#TODO - shore up the exception handling for database functions

class wxUI(wx.Frame):
    '''A simple wxFrame for the SkinDepth program.'''
    def __init__(self,parent=None):
        wx.Frame.__init__(self,id=-1,name='',
            parent=None,title='SkinDepth')
        self.init_menubar()
    ...
    def init_components(self):
        ...
        self.materials_list = wx.ListBox(self.main_panel,id=wx.ID_ANY,name="Available Materials")
        ...
        self.freq_units_cb = wx.ComboBox(self.main_panel,wx.ID_ANY,u"",
        ...
        self.sd_recalc_btn = wx.Button(self.main_panel,wx.ID_ANY,u"Calculate Skin Depth",
                               wx.DefaultPosition,wx.DefaultSize,0)
        ...
        self.sd_lbl = wx.StaticText(self.main_panel,wx.ID_ANY,u"Skin Depth:",
                                    wx.DefaultPosition,wx.DefaultSize,0)
        self.sd_tc = wx.TextCtrl(self.main_panel,wx.ID_ANY,u"",
                                 wx.DefaultPosition,wx.DefaultSize,0)
        self.sd_units_choices = [u'mm',u'm',u'inches',u'feet']
        self.sd_units_cb = wx.ComboBox(self.main_panel,wx.ID_ANY,u"",
                                       wx.DefaultPosition,wx.DefaultSize,
        ...
        self.freq_recalc_btn = wx.Button(self.main_panel,wx.ID_ANY,u"Calculate Frequency",
                                       wx.DefaultPosition,wx.DefaultSize,0)
        ...
        self.SetStatusText("SkinDepth Copyright (C) 2010 Chris Coughlin")
        self.Layout()

    def about(self,evt):
        '''Shows the About Dialog'''
        about_dlg = wxAbout.About()
    ...
    def open(self,evt):
        ...
        dlg = wx.FileDialog(self,message='Choose File To Open',
        ...
        if dlg.ShowModal() == wx.ID_OK:
            try:
                ...
                errdlg = wx.MessageDialog(self, caption='Unable To Read File',
                               message='SkinDepth was unable to read this materials file.\n',
    ...
    def saveas(self,evt):
        ...
        dlg = wx.FileDialog(self,message='Choose Destination File',
                            defaultDir=os.getcwd(), defaultFile='',
    ...
    def importdb(self,evt):
        ...
        dlg = wx.FileDialog(self, message='Choose File To Import',
                            defaultDir=os.getcwd(), defaultFile='',
                            style=wx.OPEN)
        if dlg.ShowModal() == wx.ID_OK:
            try:
                ...
                dlg = wx.MessageDialog(self, caption='Unable To Import File',
                   message='SkinDepth was unable to import the selected file.',
                   style = wx.OK | wx.ICON_ERROR
                   )
                dlg.ShowModal()
                dlg.Destroy()
    ...
    def remote_update(self, evt):
        ...
        progress_dlg = wx.ProgressDialog(title='Retrieving Updates',
                                         message = 'Fetching updates, please wait...')
        progress_dlg.Pulse()
        wx.MilliSleep(350)
        try:
            ...
            err_dlg = wx.MessageDialog(self, caption='Unable To Fetch Updates',
                               message=msg,
                               style = wx.OK | wx.ICON_ERROR
                               )
            err_dlg.ShowModal()
    ...
    def add_material(self,materialname=None):
        ...
        if materialname is not None:
            ...
            dlg.set_material(matname=matdict["name"],matiacs=matdict["iacs"],
                            matmu=matdict["mu_r"],matnotes=matdict["notes"])
        if dlg.ShowModal() == wx.ID_OK:
    ...
    def delete_material(self):
        ...
        if materialname != '':
            dlg = wx.MessageDialog(self,'Are you sure you want to delete %s from the materials list?' % (materialname),
                                   'Remove %s?' % (materialname),
                                   wx.OK | wx.CANCEL | wx.ICON_QUESTION)
            if dlg.ShowModal() == wx.ID_OK:
    ...
    def calc_frequency(self):
        ...
        if materialname != '':
            try:
                ...
                new_freq = round(self.controller.calcfrequency(materialname,skindepth) / self.get_frequnits_factor(), 3)
